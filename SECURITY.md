...
Replace this section with the supported versions for `manifestmark`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `manifestmark` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in manifestmark.
